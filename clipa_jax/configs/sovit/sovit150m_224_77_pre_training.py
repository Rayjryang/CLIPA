...
def get_config(arg=None):
  ...
  arg = bvcc.parse_arg(
      arg,  res=224, runlocal=False, batchsize=16384, token_len=77, txt='bert_base', img='ross_So150m/14',
...
#   config.input.data = dict(name='liaon-400m', split='full', data_dir='')
  ...
  dim = {'T': 192, 'S':384, 'B': 512, "So150m": 512,'ross_So150m': 512, 'L': 768, 'H': 1024}[arg.img.split("/")[0]]
 # dim = 768
