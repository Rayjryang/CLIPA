...
def get_config(arg=None):
  ...
  arg = bvcc.parse_arg(
      arg,  res=224, runlocal=False, batchsize=16384,  token_len=32, txt='bert_base', img='So400m/14',
 ...
 # input section include augmentation
  ...
  config.wandb = dict(
      ...
      experiment=f'v3-256-sovit400m14_datacomp1b_65k_{arg.res}_{arg.token_len}_gap_sin2d_12.8b_resume_from_v3128_finetune_224_128m',
      entity='1999ray9999'
  )
