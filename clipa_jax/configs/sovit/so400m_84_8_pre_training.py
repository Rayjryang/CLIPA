...
def get_config(arg=None):
  ...
  arg = bvcc.parse_arg(
      arg,  res=84, runlocal=False, batchsize=65536,  token_len=8, txt='bert_base', img='So400m/14',
 ...
 # input section include augmentation
  ...
  vitual_imagenet_epoch = 10000 * 0.2 * 1.456
  ...
  config.wandb = dict(
        ...
        experiment=f'v3-256-sovit400m14_datacomp1b_65k_{arg.res}_{arg.token_len}_gap_sin2d_align_H14_2.56b_FLOPs',
        entity='1999ray9999'
    )
