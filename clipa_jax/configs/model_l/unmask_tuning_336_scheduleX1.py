...
def get_config(arg=None):
  ...
  arg = bvcc.parse_arg(
      arg,  res=336, runlocal=False, batchsize=16384, token_len=32, txt='bert_base', img='L/14',
 ...
 # input section include augmentation
  ...
  config.total_steps = int(131072000*1.226701058 // arg.batchsize)  # seen_samples // batchsize to get the number of steps
  ...
  config.wandb = dict(
      ...
      experiment=f'v3-256-L14-datacomp1b-bs65k_84_8_gap_sin2d_8e-6_wm3200_align_H14_2.56b_FLOPs_ft_align_224_512m_336_128m',
      entity='1999ray9999' 
  )
