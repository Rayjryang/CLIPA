...
WORK_DIR='gs://lxh_jaxtpu_us_central2/jinruiyang_ckpt/clipa/tpu-pod-v4-64-convnext-B-align-dfn-onsubset-res60-bs4096_finetune_res224' # should be different with pre-train work dir or you will automatically resume pre-training
